...
\documentclass[twocolumn,9pt]{article} % use larger type; default would be 10pt
...
\usepackage[top=0.9in,bottom=0.9in, left=.5in,right=0.5in, includefoot]{geometry}
...
%\input{flat_plates}
%
\input{punching_shear}
%
%\input{slab_column_connection}
%
%\input{shear_reinforcement}
%
%\input{progressive_collapse}

\input{steel_column_flat_plate}
